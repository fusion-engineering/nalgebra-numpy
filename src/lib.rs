...
//!
//! A nalgebra matrix can also be converted to a numpy array, using [`matrix_to_python`].
...
//! ```
//! # #![feature(proc_macro_hygiene)]
//! use nalgebra_numpy::matrix_to_python;
//! use nalgebra::Matrix3;
//! use inline_python::python;
//!
//! let gil = pyo3::Python::acquire_gil();
//! let matrix = matrix_to_python(gil.python(), &Matrix3::<i32>::new(
//!     0, 1, 2,
//!     3, 4, 5,
//!     6, 7, 8,
//! ));
